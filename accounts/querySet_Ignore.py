"""
Ignore this file. It is list of queries. Aggregated together to reduce
development time.
...
#***(6)Returns all orders related to customer (firstCustomer variable set above), here order is model name (Order)
